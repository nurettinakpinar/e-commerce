...
export default function EditAbout() {
    ...
    async function save() {
        try {
            setSaving(true);
            await requests.Content.update("about", value);
    ...
    if (loading) {
        return (
            <Box>
                <Typography variant="h5" sx={{ mb: 2 }}>Hakkımızda İçeriği Yükleniyor...</Typography>
                <LinearProgress />
            </Box>
        );
    }
            ...
            <Paper elevation={3} sx={{ p: 3 }}>
                <Stack spacing={3}>
                    <Typography variant="body2" color="text.secondary">
                        Bu içerik "Hakkımızda" sayfasının ana bölümünde görüntülenecektir.
                    </Typography>
